                      ...
                      <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                          <form onSubmit={handleSubmit} className='space-y-6'>
                              <div> 
                                  ...
                                  <input type="text" id='name' value={formData.name} onChange={handleChange} className='w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none fucus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-300' placeholder='Your name' />
                              </div>
                              ...
                              {
                                  status.message && (
                                      <div className={`p-4 rounded-xl ${status.type === 'success' ? 'bg-green-500/10 border border-gray-500/20 text-gray-400' : "bg-red-500/10 border border-red-500/20 text-red-400"}`}>
                                          {status.message}
                                      </div>
                                  )
                              }
                              ...
                              <div className="group relative bg-white/5 border border-white/10 rounder-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                                  <div className="flex items-start gap-4">
                                      ...
                                      <div className="flex-1">
                                          ...
                                          <a href={`mailto:${PERSONAL_INFO}`} className='text-white hover:text-[#A8FF8D] transition-colors font-medium'>{PERSONAL_INFO.email}</a>
                                      </div>
                                  </div>
