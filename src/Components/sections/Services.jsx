  ...
  return (
      <section id='services' className='relative py-20 bg-black overflow-hidden'>
          <div className="absolute inset-0 overflow-hidden">
              <div className="absolute top-1/4 left-1/4 w-96 bg-primary/20 opacity-20 rounded-full blur-3xl" />
                  ...
                  <FadeIn delay={0}>
                      <div className="text-center mb-16">
                          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6">
                              ...
                              <span className='text-sm text-primary font-medium tracking-wider '>What I Offer</span>
                          </div>
                          ...
                          <p className='text-lg text-white/60 max-w-xl mx-auto'>
                              Comprehensive solution to transform your ideas
                          </p>
                      </div>
                  </FadeIn>
                      ...
                      {services.slice(2).map((service, index) => {
                          ...
                          return (
                              <FadeIn key={service.id} delay={300 + index * 100}>
                                  <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300  w-full h-full">
                                      <div className="mb-4">
                                      ...
                                      <div >
                                          <h3 className='text-lg font-semibold text-white mb-2 group-hover:text-[#A8FF8D] transition-color duration-300'>{service.title}</h3>
                                          <p className='text-sm text-white/60 leading-relaxed line-clamp-3'>
                                              {service.description}
                                          </p>
                                      </div>
                                      <div className="absolute inset-0 bg-linear-to-br from-primary/0 group-hover:from-primary/5 group-hover:to-primary/5 rounded-2xl transition-all duration-300 pointer-events-none"/>
                                  </div>
                              </FadeIn>
                          )
                      })}
