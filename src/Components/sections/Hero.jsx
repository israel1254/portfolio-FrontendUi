                  ...
                  <div className="text-left">
                      ...
                      <FadeIn delay={200}>
                          <p className='text-lg text-white/70 max-w-[[550px] mb-8'>
                              Building modern, scalable web application is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book
                          </p>
                      </FadeIn>
                          ...
                          <div className="relative overflow-hidden rounded-2xl aspect-4/5 max-w-[500px] ml-auto  group">
                              <div className="absolute inset-0 rounded-2xl overflow-hidden">
                                  ...
                                  <div className="relative rounded-2xl overflow-hidden m-[1px] h-[calc(100%-2px)]">
                                      <img src="https://i.pinimg.com/originals/4e/c2/9f/4ec29f1091a5d871956681d02143ab88.jpg" alt="Developer at work" className='w-full h-full object-cover'/>
                                  </div>
