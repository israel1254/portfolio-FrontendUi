          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <FadeIn delay={0}>
                  <div className="text-center mb-16">
                      ...
                      <p className='text-lg text-white/60 max-w-xl mx-auto'>Empowering clients with design-driven, high-quality</p>
                  </div>
              </FadeIn>
              <FadeIn delay={100}>
                  <div className="relative">
                      <div className="overflow-x-hidden scroll-smooth" ref={scrollContainerRef}
                      ...
                      <div className="flex items-center justify-center gap-2 mt-10">
                          {testimonials.map((_, index) => (
                              ...
                              className={`transition-all duration-300 rounded-full ${index === currentIndex ? 'bg-white w-6 h-2':'bg-white/30 w-2 h-2 hover:bg-white/50'}`} aria-label={`Go to testimonial ${index + 1}`}/>
                          ))}
                      </div>

                      <button onClick={prevTestimonial} className='flex absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 lg:-translate-x-4 items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover:bg-white/20 transition-all duration-300 z-10' aria-label='Previous testimonial'>
