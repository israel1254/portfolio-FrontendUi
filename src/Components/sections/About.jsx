                      ...
                      <div className="grid grid-cols-2 gap-4">
                                  ...
                                  <div className="flex items-start gap-4">
                                      ...
                                      <div className="flex-1">
                                          ...
                                          <p className='text-sm text-white/70 leading-relaxed'>
                                              Specialized in building scalable webb application whit modern technology and best practices
                                          </p>
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div className="relative group">
                              ...
                              <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                                  ...
                                  <p className='text-sm text-white/70 leading-relaxed'>
                                      Writing maintainable, well-document code that scales
                                  </p>
                              </div>
                          </div>
                          <div className="relative group">
                              <div className="absolute inset-0 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl"></div>
                              <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                                  <div className="p-3 bg-primary/10 rounded-xl w-fit mb-4">
                                      <Download className='w-5 h-5 text-primary'/>
                                  </div>
                                  <h3 className='text-base font-semibold text-white mb-2'>Performance</h3>
                                  <p className='text-sm text-white/70 leading-relaxed'>Optimizing for speed and efficient in every project</p>
                              </div>
                          </div>
                              ...
                              <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                                  <div className="grid grid-cols-3 gap-6 text-center">
                                      ...
                                      <div>
                                          ...
                                          <div className="text-xl text-white/60">Support Available</div>
                                      </div>
                                      <div>
                                          <div className="text-2xl font-bold text-primary mb-2">Fast</div>
                                          <div className="text-xl text-white/60">Delivery Time</div>
                                      </div>
                                  </div>
                              </div>
                          </div>
